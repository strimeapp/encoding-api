...
class CronDeleteUnusedVideoFileFromServerWorkerCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('cron:worker:delete-unused-video-file-from-server')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $video_file_lifetime = $this->getContainer()->getParameter('video_file_lifetime');
