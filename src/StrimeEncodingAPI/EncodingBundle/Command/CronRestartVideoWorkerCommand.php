...
class CronRestartVideoWorkerCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('cron:worker:restart-video')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $endpoint = $strime_api_url."encoding-job/video/is-worker/stucked";
        ...
        if($curl_status == 200) {
            ...
            foreach ($jobs as $job_id) {
                ...
                $endpoint = $strime_api_url.'encoding-job/video/'.$job_id.'/edit';
